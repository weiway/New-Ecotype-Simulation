...
program demarcationsCI
  ...
  istep = numincs%npop
  Print *, "istep: ", istep
  Print *, "top npop: ", top%npop
  Print *, "bottom npop: ", bottom%npop
  if (istep .le. 0) istep = 1
  do indexnpop = bottom%npop, top%npop, istep
	Print *, "+++++++++++++++++++++++++TIER PRIME+++++++++++++++++++START"
	...
	Print *, "STARTING FREDPROGRAM"
    call fredprogram (params, yvalue)
	Print *, "FINISHED DEMARCATIONS-CI"
    write (unit = outputUnit, fmt = *) params(3), ',', yvalue
	Print *, "+++++++++++++++++++++++++TIER PRIME++++++++++++++++++++END"
  end do
