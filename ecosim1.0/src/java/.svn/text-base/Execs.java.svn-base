...
public class Execs {
    ...
    /**
     *  Runs the initial Fred method to find a good value with which to do hill climbing.
     *
    ...
    public int runFred() {
        String[] command = {
            ...
            workingDirectory + "acinas.dat",
            workingDirectory + "acinas.out",
            workingDirectory + "time.out",
            Boolean.toString(masterVariables.getDebug())
        };
        return runApplication("Fred Method", command, true);
    }
     ...
     *  @return The exit value.
     */
    public int runDemarcationsCI() {
        String[] command = {
            binaryDirectory + "demarcationsCI" + binaryExtension,
            workingDirectory + "demarcationsIn.dat",
            workingDirectory + "demarcationsOut.dat",
            Boolean.toString(masterVariables.getDebug())
        };
        return runApplication("Demarcations CI", command, true);
    }
    ...
    */
    ...
    private double defaultBinLevels[] = {
        0.800, 0.850, 0.9000, 0.9500, 0.9600, 0.9700, 0.9800, 0.9900, 0.9950, 1.0000
    };
}
