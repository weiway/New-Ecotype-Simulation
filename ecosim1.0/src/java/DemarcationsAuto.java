...
public class DemarcationsAuto extends JFrame {
     ...
     */
    public DemarcationsAuto(FredOutVal hClimbResult, BinningAndFred values, Fasta inputFasta, File treeFile, MasterVariables masterVariables, String id) {
    ...
    // let's modify this one to output demarcations where we want to in fact we can make our own
    private void printDemarcations() {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        //     narr.println("Saving to: " + userFile.getName());
            try {
                ...
                FileWriter writer = new FileWriter(new File("../output/Ecosim_" +id + ".csv"));
