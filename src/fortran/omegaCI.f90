...
program omegaCI
  ...
  input_file = 'omegaIn.dat'
  output_file = 'omegaOut.dat'
  ...
  ! Output the answer.
  write (unit = output_unit, fmt = *) 'upper bound omega ', upperbound, &
  ...
  ! Output the answer.
  write (unit = output_unit, fmt = *) 'lower bound omega ', xlowerbound, &
