...
public class Phylogeny implements Runnable {
    ...
    private boolean verifyPhylogeny() {
        ...
        int fastaRemoved = 0;
		System.out.println("Seqs in the fasta file but not in the tree file:");
        ...
        int newickRemoved = 0;
		System.out.println("Seqs in the tree file but not in the fasta file:");
        ...
        if (fastaIds.size() == 0 || fastaIds.size() != newickNodes.size()) {
            verified = false;
			System.out.println(fastaIds.size());
			System.out.println(fastaIds.size());
			System.out.println(newickNodes.size());
        }
        return verified;
    }
